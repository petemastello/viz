...
// ── Colormap + scale ────────────────────────────────────────────────────────
// WMTS style: cmap:jet, range:0.03/0.5, logScale
const KD_MIN  = 0.03;
const KD_MAX  = 0.5;
const LOG_MIN = Math.log(KD_MIN);  // −3.507
const LOG_MAX = Math.log(KD_MAX);  // −0.693

// Matplotlib "jet" colormap: R,G,B ∈ [0,1] for normalised t ∈ [0,1]
function jetRGB(t) {
...
// Pre-build LUT: 512 entries covering the full jet range
